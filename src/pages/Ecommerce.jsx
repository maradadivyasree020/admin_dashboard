        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl  m-3 p-4 md:w-780'>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-2xl font-semibold'>$90,000</span>
                  <span className='p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-green-400 ml-3 test-xs'>20%</span>
                </p>
              ...
              {/* <div className='mt-5'><SparkLine currentColor={currentColor} id="line-sparkline" type="Line" height="800px" width="250px" data={SparklineAreaData} color={currentColor}/></div> */}
