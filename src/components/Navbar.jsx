...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between md:ml-6 md:mr-6 p-2 relative'>
      ...
      <div className="flex">
        ...
        <TooltipComponent content="Profile" position='BottomCenter'>
          <div className='flex items-center gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-lg' onClick={()=>handleClick('userProfile')}>
            ...
            <p><span className='text-gray-400 text-14'>Hi,</span>{' '}<span className='text-gray-400 font-bold ml-1 text-14'>Micheal</span></p>
